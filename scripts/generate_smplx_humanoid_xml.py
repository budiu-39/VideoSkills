...
def build_and_write_smplx_humanoid_xml(betas, gender):
    """生成 SMPL-X humanoid 的 XML 文件，供 mujoco 直接加载。
    1) 先构模
    2) 再设置各关节的阻尼/刚度
    3) 写 XML
    """
    ...
    robot_cfg = {
        "model": "smplh",   # 若要 SMPL-H，请改成 "smplh"
        "mesh": False,
        "upright_start": True,
        "freeze_hand": False,
        "replace_feet": True,
    ...
    smpl_robot = SMPL_Robot(robot_cfg, data_dir="data/SMPL/smplh")
