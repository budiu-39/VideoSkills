...
smpl_robot = SMPL_Robot(robot_cfg, data_dir="/home/miku/Documents/VideoSkills/data/smpl")

# 1) 先构模
smpl_robot.load_from_skeleton(betas=torch.zeros(1, 10), gender=[0])  # 0=neutral, 1=male, 2=female
...
set_joint_ds(smpl_robot, default_d=50.0, default_k=500.0, per_joint=per_joint)

# 3) 写 XML
smpl_robot.write_xml("/home/miku/Documents/VideoSkills/data/robots/smpl/smpl_humanoid_v2.xml")
